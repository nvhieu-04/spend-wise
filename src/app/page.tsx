    ...
    <div className="container mx-auto px-2 py-4 sm:px-4 sm:py-8">
      ...
      <div className="bg-white p-3 text-gray-900 sm:p-6 md:p-8">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mb-4 flex flex-col items-start justify-between gap-2 rounded-lg border border-blue-50 bg-blue-50 px-3 py-2 text-xs text-gray-700 sm:flex-row sm:items-center sm:px-4 sm:py-3 sm:text-sm">
            <span>{dict.cashback.optimizerDescription}</span>
            <Link
              href={optimizerHref}
              className="inline-flex items-center rounded-md bg-blue-600 px-3 py-1.5 text-xs font-medium text-white hover:bg-blue-700 sm:text-sm"
            >
              {dict.cashback.optimizerTitle}
            </Link>
          </div>
